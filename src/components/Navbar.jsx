      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <nav className="flex items-center justify-between p-6 lg:px-8">
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {navigation.map((item) => (
              <a 
                key={item.name} 
                href={item.href} 
                className={`text-sm font-semibold leading-6 ${isDark ? 'text-white' : 'text-gray-900'}`}
              >
                {item.name}
              </a>
            ))}
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:items-center lg:gap-4">
            ...
            <a href="#" className={`text-sm font-semibold leading-6 ${isDark ? 'text-white' : 'text-gray-900'}`}>
        ...
        <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
          ...
          <DialogPanel className={`fixed inset-y-0 right-0 z-50 w-full overflow-y-auto px-6 py-6 sm:max-w-sm sm:ring-1 ${
            isDark ? 'bg-gray-900 ring-gray-100/10' : 'bg-white ring-gray-900/10'
          }`}>
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className={`relative rounded-full px-3 py-1 text-sm leading-6 ${
              ...
              <a href="#" className={`font-semibold ${isDark ? 'text-indigo-400' : 'text-indigo-600'}`}>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-30">
          <button
            ...
            className={`flex items-center justify-center h-12 w-12 rounded-full shadow-md ring-1 ${
              isDark ? 'bg-gray-800 text-indigo-300 ring-white/10 hover:bg-gray-700' : 'bg-white text-indigo-600 ring-gray-200 hover:bg-gray-50'
            }`}
          >
